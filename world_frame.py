...
class World:
    def __init__(self, grid_size, num_robots, goal_radius = 12):
        ...
        self.prev_grid = np.zeros(shape=(grid_size, grid_size), dtype=np.int16)
    ...
    def tick(self):
        ...
        for id in range(1, len(self.robot_array)):
            ...
            new_position = self.get_new_position(robot.movment_choice(np.array([1, 4, 3, 2, 1])), robot.get_position()) #TODO: insert movement choice
